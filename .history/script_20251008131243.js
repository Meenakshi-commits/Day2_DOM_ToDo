...
addTaskButton.addEventListener("click",()=> {
    ...
    // add a right margin so there's space between the button and the task text
    deleteButton.className = "text-red-500 hover:text-red-700 mr-4";
    ...
    taskInput.focus(); // Refocus input field for convenience
